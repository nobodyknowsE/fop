    ...
    t1 :: Tree Bool
    t1 = Branch (Branch (Branch (Branch Leaf False Leaf) True Leaf) True Leaf) False Leaf

    t2 :: Tree Bool
    t2 = Branch Leaf False (Branch Leaf True (Branch Leaf True (Branch Leaf False Leaf)))
